...
See playbooks_variables for details on how Ansible chooses among variable values defined in different places (variable inheritance and scope). Also, deduplication happens ONLY at the play level, so multiple plays in the same playbook may rerun the roles.
...
Read the [Ansible Galaxy documentation](https://ansible.readthedocs.io/projects/galaxy-ng/en/latest/) page for more information.
