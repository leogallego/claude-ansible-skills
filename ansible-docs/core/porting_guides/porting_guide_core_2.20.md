...
Review this page and the [ansible-core Changelog for 2.20](https://github.com/ansible/ansible/blob/stable-2.20/changelogs/CHANGELOG-v2.20.rst) to understand necessary changes.
