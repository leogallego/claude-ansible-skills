...
declare -A SECTION_MAP=(
  ...
  [roles]="ansible-good-practices,ansible-new-role,ansible-new-collection"
  [collections]="ansible-good-practices,ansible-new-collection"
  [playbooks]="ansible-good-practices"
  [inventories]="ansible-good-practices"
  [plugins]="ansible-good-practices"
  [coding_style]="ansible-good-practices,ansible-new-role,ansible-new-collection,ansible-new-ee"
  [aap_configuration]="ansible-good-practices"
  [cicd_and_promotion]="ansible-good-practices,ansible-new-collection"
  [git_workflow]="ansible-good-practices"
  [naming_conventions]="ansible-good-practices,ansible-new-role,ansible-new-collection"
  [security]="ansible-good-practices,ansible-new-role"
  [testing]="ansible-good-practices,ansible-new-role,ansible-new-collection"
)
